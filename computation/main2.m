...
ini = load('/Users/Phantom/Desktop/Code/data/jm=-0.25_ini.mat');
jp_all = ini.jp_all;
A0 = ini.A(jp_all == jp);
B0 = ini.B(jp_all == jp);
...
%% Output root
outroot = '/Users/Phantom/Desktop/CEP/jm=-0.25/SI/';
if ~exist(outroot,'dir'); mkdir(outroot); end

outfile  = fullfile(outroot, 'S1A.mat');
...
%
% --correlations--
avg.C_AA = avg_fluc.C_AA;
avg.C1_AA = abs(avg_fluc.C1_AA);
avg.C2_AA = mean(abs(avg_fluc.C2_AA),2);

avg.phase_AA = avg_fluc.phase_AA;
avg.phase1_AA = abs(avg_fluc.phase1_AA);
avg.phase2_AA = mean(abs(avg_fluc.phase2_AA),2);

% -- Var(theta) --
avg.Var_A = avg_fluc.Var1 - avg_fluc.Var2;
avg.Var1_A = avg_fluc.Var1 - avg_fluc.Var3.^2;
avg.Var2_A = mean(avg_fluc.Var4,2) - mean(avg_fluc.Var5.^2,2);
