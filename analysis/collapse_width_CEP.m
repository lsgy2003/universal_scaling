...
m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^8_width.mat');
corr1=m.corr2(:);  %m.corr1: in-phase mode, m.corr2: out-of-phase mode

m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^9_width.mat');
corr2=m.corr2(:);

m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^10_width.mat');
corr3=m.corr2(:);

m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^11_width.mat');
corr4=m.corr2(:);
%
m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^12_width.mat');
corr5=m.corr2(:);
...
saveas(gcf,'/Users/Phantom/Desktop/Code/data/CEP_scaling_widthAB1.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/CEP_scaling_widthAB1.eps','ContentType','vector','BackgroundColor','none');
...
saveas(gcf,'/Users/Phantom/Desktop/Code/data/CEP_scaling_widthAB3.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/CEP_scaling_widthAB3.eps','ContentType','vector','BackgroundColor','none');
