...
m=load('/Users/Phantom/Desktop/Code/data/Chiral/xi=0.005_ws_all_2.mat');
sigma1=0.005^2;
j1=m.jp_all;
freq1=m.freq_s;
...
m=load('/Users/Phantom/Desktop/Code/data/Chiral/xi=0.05_ws_all_2.mat');
sigma2=0.05^2;
j2=m.jp_all;
freq2=m.freq_s;
...
m=load('/Users/Phantom/Desktop/Code/data/Chiral/xi=0.1_ws_all_2.mat');
sigma3=0.1^2;
j3=m.jp_all;
freq3=m.freq_s;
std_freq3=m.std_freq_s;

m=load('/Users/Phantom/Desktop/Code/data/Chiral/xi=0.15_ws_all_2.mat');
sigma4=0.15^2;
j4=m.jp_all;
freq4=m.freq_s;
std_freq4=m.std_freq_s;

m=load('/Users/Phantom/Desktop/Code/data/Chiral/xi=0.5_ws_all_2.mat');
sigma5=0.5^2;
j5=m.jp_all;
freq5=m.freq_s;
...
ax.FontSize=18;
yscale('log');
ImageID='/Users/Phantom/Desktop/Code/data/Figure/xover_all_2.fig';
saveas(gcf,ImageID);
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/xover_all_2.eps','ContentType','vector','BackgroundColor','none');
