...
m=load('/Users/Phantom/Desktop/Code/data/Chiral/2^13_xi=0.001.mat');
freq0=m.omega1(:);

m=load('/Users/Phantom/Desktop/Code/data/Chiral/2^13_xi=0.01.mat');
freq1=m.omega1(:);

m=load('/Users/Phantom/Desktop/Code/data/Chiral/2^13_xi=0.1.mat');
freq2=m.omega1(:);

m=load('/Users/Phantom/Desktop/Code/data/Chiral/2^13_xi=0.2.mat');
freq3=m.omega1(:);

m=load('/Users/Phantom/Desktop/Code/data/Chiral/2^13_xi=0.3.mat');
freq4=m.omega1(:);
%
m=load('/Users/Phantom/Desktop/Code/data/Chiral/2^13_xi=0.4.mat');
freq5=m.omega1(:);

m=load('/Users/Phantom/Desktop/Code/data/Chiral/2^13_xi=0.5.mat');
freq6=m.omega1(:);
%}
clf;
figure(1)
...
saveas(gcf,'/Users/Phantom/Desktop/Code/data/omega_xi_L=2^13_1.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/omega_xi_L=2^13_1.eps','ContentType','vector','BackgroundColor','none');
...
ax = gca;
ax.FontSize=18;
saveas(gcf,'/Users/Phantom/Desktop/Code/data/omega_xi_L=2^13_2.fig');
