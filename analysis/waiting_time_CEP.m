...
m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^11_tw=100.mat');
corr1=m.avg_fluc.C_AA(:);
Dcorr1 = -log(corr1);
Dt1=1:dt*Evo:(T-tw(1))+1;

m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^11_tw=1000.mat');
corr2=m.avg_fluc.C_AA(:);
Dcorr2 = -log(corr2);
Dt2=1:dt*Evo:(T-tw(2))+1;

m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/CEP/2^11_tw=3000.mat');
...
ylabel('\chi_{AA}(t_0,t_0+t;L)','FontSize',20)
ax = gca;
ax.FontSize=16;
...
%
ImageID='/Users/Phantom/Desktop/Code/data/waiting_time_CEP_2^11.fig';
saveas(gcf,ImageID);
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/waiting_time_CEP_2^11.eps','ContentType','Vector','BackgroundColor','None');
%}