...
n = 2.^(6:10);
%
m=load('/Users/Phantom/Desktop/Code/data/jm=-0.25/SI/S4C.mat');
...
%
ImageID='/Users/Phantom/Desktop/Code/data/ensemble_pattern_C_AA_1.fig';
saveas(gcf,ImageID);
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/ensemble_pattern_C_AA_1.eps','ContentType','vector','BackgroundColor','none');
%}
...
txt = {'$\sim \rm{const.}$'};
text(200,0.75,txt,'FontSize',25,'Interpreter','latex');
hold on;
...
ax = gca;
ax.FontSize=16;
axis([40 1100 0.6 0.8]);
box on;


%
ImageID='/Users/Phantom/Desktop/Code/data/ensemble_pattern_C_AA_2.fig';
saveas(gcf,ImageID);
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/ensemble_pattern_C_AA_2.eps','ContentType','vector','BackgroundColor','none');
%}



%save('/Users/Phantom/Desktop/Code/data/jm=-0.25/Chiral/ws_jp=0.0097_1.mat','width_s','std_width_s','alpha','standard_errors_alpha');
