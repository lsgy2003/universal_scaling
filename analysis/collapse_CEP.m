...
Dcorr5 = -log(corr5_1*0.6+corr5_2*0.4);
...
hold off;
%
saveas(gcf,'/Users/Phantom/Desktop/Code/data/CEP_AA_scaling1.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/CEP_AA_scaling1.eps','ContentType','vector','BackgroundColor','none');
...
%xlabel('t/L^{z}')
%ylabel('\chi_{AA}(t_0,t_0+t;L)/L^{2\alpha}')
ax = gca;
ax.FontSize=18;
...
hold off;
%
saveas(gcf,'/Users/Phantom/Desktop/Code/data/CEP_AA_scaling3.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/CEP_AA_scaling3.eps','ContentType','vector','BackgroundColor','none');
%}
