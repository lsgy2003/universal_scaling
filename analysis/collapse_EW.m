...
Dcorr1 = -log(corr1_1*0.4+corr1_2*0.6);
...
saveas(gcf,'/Users/Phantom/Desktop/Code/data/Figure/Updated/EW_scaling1.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/Figure/Updated/EW_scaling1.eps','ContentType','vector','BackgroundColor','none');
...
text(5*10^(-4),2*10^(-8),txt,'Interpreter','latex','FontSize',25);
txt = {'$z=2$'};%,P_g(1)/2
text(5*10^(-4),10^(-8),txt,'Interpreter','latex','FontSize',25);
hold off;


xlabel('t/L^{z}')
ylabel('\chi_{AA}(t_0,t_0+t;LL)|/L^{2\alpha}')
axis([10^(-7) 10^(-1) 3*10^(-9) 10^(-7)]);
ax = gca;
ax.FontSize=18;

saveas(gcf,'/Users/Phantom/Desktop/Code/data/EW_scaling2.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/EW_scaling2.eps','ContentType','vector','BackgroundColor','none');
...
savefig(legendFig, '/Users/Phantom/Desktop/Code/data/EW_scaling2_Legend.fig');
exportgraphics(gcf,'/Users/Phantom/Desktop/Code/data/EW_scaling2_Legend.eps','ContentType','vector','BackgroundColor','none');
%}
