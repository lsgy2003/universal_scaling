...
Evo=1000;
Nt = T/dt;
tw = [800 1000 3000 7000];
Dt=1:dt*Evo:(T-tw(1))+1;
Dt1=1:dt*Evo:(T1-tw(1))+1;
Lx=[2^8 2^8 2^10 2^11 2^12];
n = [48 96 240 480 720 960];
%
m=load('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/sigma=0.5/jp=0.0097/Size/2^8_tw=800_chi1_n=48.mat');
corr2=m.avg_corr_psi_AA(:);
Dcorr2 = -log(corr2);
%}
m=load('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/sigma=0.5/jp=0.0097/Size/2^8_tw=800_chi1_n=96.mat');
corr3=m.avg_corr_psi_AA(:);
Dcorr3 = -log(corr3);

m=load('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/sigma=0.5/jp=0.0097/Size/2^8_tw=800_chi1_n=240.mat');
corr4=m.avg_corr_psi_AA(:);
Dcorr4 = -log(corr4);

m=load('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/sigma=0.5/jp=0.0097/Size/2^8_tw=800_chi1_n=480.mat');
corr5=m.avg_corr_psi_AA(:);
Dcorr5 = -log(corr5);
%
m=load('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/sigma=0.5/jp=0.0097/Size/2^8_tw=800_chi1_n=720.mat');
corr6=m.avg_corr_psi_AA(:);
Dcorr6 = -log(corr6);

m=load('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/sigma=0.5/jp=0.0097/Size/2^8_tw=800_chi1_n=960.mat');
...
%}
width_s = [avg_corr2 avg_corr3 avg_corr4 avg_corr5 avg_corr6 avg_corr7 ];%avg_corr1 avg_corr2  avg_corr7 avg_corr6
std_width_s = [std_corr2 std_corr3 std_corr4 std_corr5 std_corr6 std_corr7 ];%std_corr1 std_corr2 std_corr7 std_corr6
...
ax = gca;
ax.FontSize=16;
lgd=legend('N=48','N=96','N=240','N=480','N=720','N=960','Location','southwest'); 
lgd.FontSize=14;
%axis([10^1 3*10^3 0.999 1.0003]);

%
ImageID='/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/ensemble_pattern_chi1_1.fig';
saveas(gcf,ImageID);
exportgraphics(gcf,'/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/ensemble_pattern_chi1_1.eps','ContentType','vector','BackgroundColor','none');
%}
...
txt = {'$\sim \rm{const.}$'};
text(500,0.72,txt,'FontSize',25,'Interpreter','latex');
hold on;
...
%
ImageID='/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/ensemble_pattern_chi1_2.fig';
saveas(gcf,ImageID);
exportgraphics(gcf,'/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/ensemble_pattern_chi1_2.eps','ContentType','vector','BackgroundColor','none');
%}

%save('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/sigma=0.5/jp=0.0097/Size/ws_jp=0.0097_1.mat','width_s','std_width_s','alpha','standard_errors_alpha');
