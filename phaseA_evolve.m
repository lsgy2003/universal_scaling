...
m= load('/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Turing/lin_stability/phaseA_3.mat');
...
%{
saveas(gcf,'/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/pattern_phaseA_evo4.fig')
exportgraphics(gcf,'/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/pattern_phaseA_evo4.eps','ContentType','vector','BackgroundColor','none')
%}
%
f=figure(2);
f.Position = [300 300 800 300];
...
%{
saveas(gcf,'/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/pattern_ampA_evo6.fig')
exportgraphics(gcf,'/Users/Phantom/Documents/MATLAB/Flocking/Density/New_data/Figure/pattern_ampA_evo6.eps','ContentType','vector','BackgroundColor','none')
%}